...
object EnderFont {
    ...
    fun init() {
        fontRenderer = FontRenderer(Font.fromResource("/assets/endergamer/fonts/Regular"), Font.fromResource("/assets/endergamer/fonts/SemiBold"))
        println("font renderer initialization done")
    }
